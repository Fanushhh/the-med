...
export default function RootLayout({ children }) {
  return (
    <html lang="ro">
      <head>
  <link rel="icon" href="https://the-med-new.vercel.app/images/favicon-the-med.ico" sizes="any" />
  <link rel="apple-touch-icon" sizes="180x180" href="https://the-med-new.vercel.app/images/apple-touch-icon.png" />
  <link rel="icon" type="image/png" sizes="32x32" href="https://the-med-new.vercel.app/images/favicon-32x32.png" />
  <link rel="icon" type="image/png" sizes="16x16" href="https://the-med-new.vercel.app/images/favicon-16x16.png" />
  <link rel="manifest" href="https://the-med-new.vercel.app/images/site.webmanifest" />
</head>
