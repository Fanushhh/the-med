...
export const Footer = () => {
  return (
    <footer className="flex flex-col bg-black text-white font-Body ">
      <div className="footer p-10 max-w-[1400px] mx-auto !md:grid-flow-col">
        <aside>
          <h2 className="text-4xl">TheMed</h2>
          <div className="my-4">
            <p className=" ml-6 text-[var(--primary)]  text-xl mb-2">Bucuresti</p>
          ...
          <div className="my-4">
            <p className=" ml-6 text-[var(--primary)] text-xl mb-2">Slatina</p>
            <div className="flex gap-2">
              <svg
                className="w-4"
                fill="#ffffff"
        ...
        <nav>
          ...
          <Link href="#" className=" ">Protetică dentară</Link>
          <Link href="#" className=" ">Implant dentar imediat</Link>
          <Link href="#" className=" ">Chirurgie orală ghidată</Link>
          <Link href="#" className=" ">Endodonție microscop</Link>
          <Link href="#" className=" ">Parodontologie laser</Link>
          <Link href="#" className=" ">Igienizare profesională EMS</Link>
          <Link href="#" className=" ">Terapia cariei</Link>
          <Link href="#" className=" ">Laborator dentar</Link>
        </nav>
        <nav>
          <h6 className="text-2xl pb-4 mb-4 border-b-2 border-[var(--accent)]">Legal</h6>
          <Link href="#" className=" ">Termeni și condiții</Link>
          <Link href="#" className=" ">Politica de confidențialitate</Link>
          <Link href="#" className=" ">Politica de cookies</Link>
        </nav>
      </div>
