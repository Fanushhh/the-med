...
export const Locations = () => {
  ...
  return (
    <motion.section  className="my-10 overflow-clip p-4 locations">
      <h2 className="text-4xl text-[var(--accent)] mt-6 mb-10 md:max-w-[900px] md:mx-auto md:text-center">
      ...
      <motion.div initial={{y:150, opacity:0}} transition={{duration:1}} animate={isInView ? {y:0, opacity:1}: {}} ref={locationsRef} className="flex flex-col-reverse items-center md:flex-row justify-center gap-8">
        ...
        <aside className="w-[580px] max-w-full flex flex-col justify-between font-bold !font-Body">
          <p className="">
          ...
          <div className="p-4 border-b-2 border-[var(--accent)] *:mb-2 ">
            ...
            <Link
              ...
              href="https://maps.app.goo.gl/aFoZdGX9ZU1yUtAq9"
              target="_blank"
            >
              Vezi locatia
            </Link>
          ...
          <div className="p-4 border-b-2 border-[var(--accent)] *:mb-2">
            ...
            <div className="flex gap-2">
              ...
              <a href="tel:+40 749 381 050">+40 749 381 050</a>
            </div>
            <Link
              className="ml-auto block text-xl !font-Body text-[var(--accent)]"
